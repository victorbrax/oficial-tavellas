...
REPORT_PATH = os.path.join(STATIC_PATH, "reports")
...
class Config(object):
    ...
    MAIL_PORT = 587
    MAIL_USE_TLS = True
    MAIL_DEFAULT_SENDER = "thortavellas@gmail.com" # Alterar para credenciais do aplicativo.
    MAIL_USERNAME = "thortavellas@gmail.com"
    MAIL_PASSWORD = "bjsa fnej ugdu kqyu"
